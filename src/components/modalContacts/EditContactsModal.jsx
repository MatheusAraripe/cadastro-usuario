...
import { checkCpf, extractCpfNumbers, getContactsFromLs } from "../../utils";
...
const validationSchema = yup.object().shape({
    ...
    cpf: yup
        ...
        .max(11, "CPF maior que o permitido"),
            ...
            <form onSubmit={handleSubmit(handleEdit)}>
                <ModalContactsMain isForm={true}>
                    ...
                    >
                        <FormLabel
                            id="genderLable"
                            sx={{ color: "purple.dark", marginRight: "35px" }}
                            color="secondary"
                        >
                            Sexo
                        </FormLabel>
